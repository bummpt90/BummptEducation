/**
 * BummptEducation — Database Migration Runner
 * 
 * Executes version-controlled SQL migrations against PostgreSQL safely
...
// In-code registry of migrations (ensures cross-platform bundling compatibility with esbuild)
export const MIGRATIONS: MigrationDefinition[] = [
  ...
  {
    version: '0003',
    name: 'auth_and_identity_foundation',
    sql: `
  ...
  {
    version: '0005',
    name: 'academic_operations_foundation',
    sql: `
  ...
  {
    version: '0006',
    name: 'admissions_fees_bursary_foundation',
    sql: `
  ...
  {
    version: '0008',
    name: 'parent_identity_and_access',
    sql: `
  ...
  {
    version: '0009',
    name: 'attendance_server_authority',
    sql: `
  ...
  {
    version: '0010',
    name: 'lesson_notes_and_inquiries',
    sql: `
  ...
  {
    version: '0011',
    name: 'hq_telemetry_directives_messaging',
    sql: `
...
export async function runMigrations(): Promise<MigrationResult> {
  ...
  if (!config.isConfigured) {
    return {
      ...
      appliedVersions: [],
      skippedCount: 0,
      error: 'Database is not configured. Skipping migrations in preview/development mode.',
    };
  }
  ...
  try {
    ...
    for (const migration of MIGRATIONS) {
      ...
      console.log(`[Migrations] Successfully applied ${migration.version}: ${migration.name}`);
